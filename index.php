  ...
  <div id="navWrapper">
          <div id="p7TMM_1" class="p7TMM05">
            <ul class="p7TMM level_1" id="p7TMM_1u1">
              <li><a href="servicos.php?page=projetos">Projetos</a></li>
              <li><a href="servicos.php?page=treinamentos" class="trig_open">Treinamentos</a></li>
              <li><a href="servicos.php?page=auditoria-sistemas">Auditoria de Sistemas</a></li>
              <li><a href="servicos.php?page=supervisao-partida-assistida">Supervisão e Partida Assistida</a></li>
            </ul>
            <!--[if lte IE 6]>
...
//-->
  ...
  <div style="width:690px; float:left;">
    ...
    <p>Uma diferenciada seleção de cursos profissionalizantes de irrigação para praticantes do Uso Inteligente da Água 
      ...
      <p style="text-align:center;"><img src="images/capa-treinamentos.jpg" width="341" height="203" alt=""/></p>
    <div class="clear"></div>
    ...
    <div class="accordion">
      ...
      <div>
        ...
        <p><img src="images/capa-hidraulicabasica.jpg" width="685" height="213" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-produtos-irrigacao.jpg" width="687" height="213" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-projeto-irrigacao-jardins.jpg" width="689" height="218" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-irrigacao-localizada.jpg" width="687" height="220" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-eletrica-basica.jpg" width="685" height="223" alt=""/></p>
      </div>
    </div>
    ...
    <div class="accordion">
      ...
      <div>
        ...
        <p><img src="images/capa-instalacao-manutencao-problemas.jpg" width="687" height="223" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-orcamento-sistemas.jpg" width="691" height="223" alt=""/></p>
      </div>
    </div>
    ...
    <div class="accordion">
      ...
      <div>
        ...
        <p><img src="images/capa-curso-vendas-irrigacao.jpg" width="692" height="228" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-sistemas-bombeamento.jpg" width="690" height="228" alt=""/></p>
      </div>
      <h3>C3 – Aspersor LF – “Low Flow”</h3>
      <div>
        <p>Para quem deseja aprender tudo sobre o mais inovador aspersor do mercado.</p>
        <p><img src="images/capa-aspersor-lf-low-flow.jpg" width="693" height="227" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-coleta-armazenamento.jpg" width="693" height="227" alt=""/></p>
      </div>
      ...
      <div>
        ...
        <p><img src="images/capa-curso-pratico-montagem.jpg" width="691" height="224" alt=""/></p>
      </div>
    </div>
  </div>
</div>
